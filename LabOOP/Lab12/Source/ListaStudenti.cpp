...
ListaStudenti<Student>::~ListaStudenti() {
...
ListaStudenti<Student>::ListaStudenti(const ListaStudenti& other):baza(nullptr), varf(nullptr),nrNoduri(0) {
...
ListaStudenti<Student>::ListaStudenti(string nume_fisier):baza(nullptr), varf(nullptr), nrNoduri(0) {
...
ListaStudenti<Student>::Nod::Nod(Student* student):next(nullptr),prev(nullptr) {
...
void ListaStudenti<Student>::adaugaBaza(Student * student) {
...
void ListaStudenti<Student>::eliminaVarf() {
...
void ListaStudenti<Student>::eliminaBaza() {
    if (nrNoduri == 0) {
        cerr<<"Eroare: Incercarea eliminarii elementelor dintr-o listă goală.\n";
        return;
    }
...
Student *ListaStudenti<Student>::extrageVarf() const {
    if (nrNoduri == 0) {
...
Student *ListaStudenti<Student>::extrageBaza() const{
    if (nrNoduri == 0) {
        cerr<<"Eroare: Incercarea extragerii unui element dintr-o listă goală.\n";
        return nullptr;
    }
...
void ListaStudenti<Student>::afiseaza() const{
...
void ListaStudenti<Student>::sterge(string nume_student) {
...
Student*& ListaStudenti<Student>::operator[](int index) {
    if (nrNoduri == 0) {
...
ListaStudenti<Student> ListaStudenti<Student>::operator+(ListaStudenti<Student>& other_lista) {
...
ListaStudenti<Student>& ListaStudenti<Student>::operator=(ListaStudenti<Student> other) {
...
void ListaStudenti<Student>::swap_studenti(Student*& a, Student*& b) {
    Student* aux = a;
    a = b;
    b = aux;
}

void ListaStudenti<Student>::sorteaza(bool (*compara)(Student*, Student*)) {
...
ListaStudenti<Student>::Nod* ListaStudenti<Student>::partitie(Nod* st, Nod* dr, bool (*compare)(Student *, Student *)) {
    int d = 1;
...
void ListaStudenti<Student>::quicksort(Nod* st, Nod* dr, bool (*compare)(Student *, Student *)) {
...
void ListaStudenti<Student>::sorteazaQ(bool (*compare)(Student *, Student *)) {
    if (nrNoduri == 0) return;
...
ostream& operator<<(ostream& out_stream, ListaStudenti<Student>& lista) {

    out_stream << "Total studenți: " << lista.nrNoduri << endl;
    for (ListaStudenti<Student>::Nod* iterator = lista.baza; iterator != nullptr; iterator = iterator->next) {
